...
int main(int, char** argv)
{
	...
	//Read first frame from the webcam 
	capWebcam.read(src);
	*/
	src = imread("sky.jpg", CV_LOAD_IMAGE_ANYDEPTH | CV_LOAD_IMAGE_COLOR);
	...
	/// FAST
	// detecting keypoints using FAST
	//Initialise the Wrapping Class for FAST()
	//FastFeatureDetector detector(400);

	//vector<KeyPoint> keypoints1, keypoints2;
	//detector.detect(src_gray, keypoints1);
	//detector.detect(src_gray, keypoints2);
